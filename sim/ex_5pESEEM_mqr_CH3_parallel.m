function [t,signal] = ex_5pESEEM_mqr_CH3_parallel(Sys,Exp,Opt)
...
%       .tau1        first echo delay [us]
%                    default: 0.100
%       .tau2        first echo delay [us]
%                    default: 0.100
%       .T           initial incremented delay [us]
%                    default: 0.100
...
parfor ori = 1:nori
    ...
    for p = 1:npoints
        ...
        sig_tmp = utau2*sig_tmp*utau2r;                                 % tau2
